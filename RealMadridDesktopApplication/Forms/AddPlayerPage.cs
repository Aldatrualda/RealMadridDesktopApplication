...
namespace RealMadridDesktopApplication.Forms
{
    public partial class AddPlayerPage : Form
    {
        ...
        {
            string insertQuery = "INSERT INTO personal_details(name, surname, additional_name, birthday, phone_number) VALUES('" + player.Name + "', '" + player.Surname + "', '" + player.AdditionalName + "', '" + player.Birthday + "', '" + player.PhoneNumber + "')";
